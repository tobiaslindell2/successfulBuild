...
def build_recipes(build_order, python_modules, ctx, project_dir,
    ...
    for arch in ctx.archs:
        ...
        custom_command_copy_build_openssl_py = (
        "cp /Users/tobiaslindell/Downloads/localStuff/modifiedFiles/build_openssl.py "
        "/Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/build/other_builds/cryptography/arm64-v8a__ndk_target_33/cryptography/src/_cffi_src"
        )
        subprocess.run(custom_command_copy_build_openssl_py, shell=True, check=True)
        

        
        '''
        custom_command_copy_build_rs = (
        "cp /Users/tobiaslindell/Downloads/localStuff/modifiedFiles/build.rs "
        ...
        subprocess.run(custom_command_copy_build_rs, shell=True, check=True)
        
        custom_command_copy_Cargo_toml = (
        "cp /Users/tobiaslindell/Downloads/localStuff/modifiedFiles/Cargo.toml "
        "/Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/build/other_builds/cryptography/arm64-v8a__ndk_target_33/cryptography/src/rust/"
        )
        subprocess.run(custom_command_copy_Cargo_toml, shell=True, check=True)
        
        custom_command_remove_Cargo_lock = (
        "rm -rf /Users/tobiaslindell/Downloads/localStuff/modifiedFiles/Cargo.lock"
        )
        subprocess.run(custom_command_remove_Cargo_lock, shell=True, check=True)
        '''
        ...
        command_add_link_to_libpython_so1 = [
        	"patchelf",
        	"--add-needed",
        	"libpython3.11.so",
        	"/Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/build/other_builds/cryptography/arm64-v8a__ndk_target_33/cryptography/build/lib.macosx-14.4-arm64-cpython-311/cryptography/hazmat/bindings/_rust.abi3.so"
        ]
        subprocess.run(command_add_link_to_libpython_so1, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        subprocess.run(command_set_rpath1, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        
        
        command_add_link_to_libpython_so2 = [
        	"patchelf",
        	"--add-needed",
        	"libpython3.11.so",
        	"/Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/build/python-installs/convokeeper/arm64-v8a/cryptography/hazmat/bindings/_rust.abi3.so"
        ]
        subprocess.run(command_add_link_to_libpython_so2, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        ...
        subprocess.run(command_set_rpath2, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def run_setuppy_install(ctx, project_dir, env=None, arch=None):
    ...
    command_add_link_to_libpython_so3 = [
    	"patchelf",
    	"--add-needed",
    	"libpython3.11.so",
    	"/Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/dists/convokeeper/_python_bundle__arm64-v8a/_python_bundle/site-packages/cryptography/hazmat/bindings/_rust.abi3.so"
    ]
    subprocess.run(command_add_link_to_libpython_so3, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    subprocess.run(command_set_rpath3, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def biglink(ctx, arch):
    ...
    #custom_command_copy_libssl11so = (
    #"cp /Users/tobiaslindell/appStuff/.buildozer/android/platform/build-arm64-v8a/build/libs_collections/convokeeper/arm64-v8a/libssl1.1.so "
    ...
    #)
    #subprocess.run(custom_command_copy_libssl11so, shell=True, check=True)
